...
<div class="movies-section">
  <h2>Films populaires (5 premiers)</h2>
  <?php
  $i = 0;
  foreach ($films['results'] as $film) {
      ...
      echo '<div class="movie">';
        echo '<div class="movie-image">';
            ...
            echo '</span>';
            echo '<a href="#"><img src="ttps://image.tmdb.org/t/p/w500/1E5baAaEse26fej7uHcjOgEE2t2.jpg" alt="" /></a>';
            echo '</div>';
...
<!-- Lien "See all" pour afficher le reste -->
<div class="see-all">
  <a href="#">
    Voir tous les films
  </a>
